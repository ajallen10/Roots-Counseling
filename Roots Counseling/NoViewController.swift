...
class NoViewController: UIViewController {
    ...
    @IBAction func nextButton(_ sender: Any) {
        if one.selectedSegmentIndex == 1 {
            sum += 1
        }
        if two.selectedSegmentIndex == 1 {
            sum += 1
        }
        if three.selectedSegmentIndex == 1 {
            sum += 1
        }
        if four.selectedSegmentIndex == 1 {
            sum += 1
        }
        if five.selectedSegmentIndex == 1 {
            sum += 1
        }
        if six.selectedSegmentIndex == 1 {
            sum += 1
        }
        if seven.selectedSegmentIndex == 1 {
            sum += 1
        }
        if eight.selectedSegmentIndex == 1 {
            sum += 1
        }
        if nine.selectedSegmentIndex == 1 {
            sum += 1
        }
        if ten.selectedSegmentIndex == 1 {
            sum += 1
        }
        
        performSegue(withIdentifier: "segNo", sender: self)
    }
