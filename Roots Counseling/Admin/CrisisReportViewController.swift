//
//  CrisisReportViewController.swift
//  RootsCapstoneProj
//
...
class CrisisReportViewController: UIViewController, UIScrollViewDelegate {
...
//        let user: String = Auth.auth().currentUser!.uid
        ...
        let des = db.collection("users").document(user).collection("Crisis").document(date).collection("please").document("Description")
        ...
        //please
        let pleaseEmo = db.collection("users").document(user).collection("Crisis").document(date).collection("please").document("Emotion")
        ...
        let pleaseAfter = db.collection("users").document(user).collection("Crisis").document(date).collection("please").document("Emotion After")
        ...
        let pleaseUse = db.collection("users").document(user).collection("Crisis").document(date).collection("please").document("Usefulness")
        ...
        //stop
        let stopEmo = db.collection("users").document(user).collection("Crisis").document(date).collection("stop").document("Emotion")
        ...
        let stopAfter = db.collection("users").document(user).collection("Crisis").document(date).collection("stop").document("Emotion After")
        ...
        let stopUse = db.collection("users").document(user).collection("Crisis").document(date).collection("stop").document("Usefulness")
        ...
        //pros
        let prosEmo = db.collection("users").document(user).collection("Crisis").document(date).collection("pros").document("Emotion")
        ...
        let prosAfter = db.collection("users").document(user).collection("Crisis").document(date).collection("pros").document("Emotion After")
        ...
        let prosUse = db.collection("users").document(user).collection("Crisis").document(date).collection("pros").document("Usefulness")
        ...
        //facts
        let factsEmo = db.collection("users").document(user).collection("Crisis").document(date).collection("facts").document("Emotion")
        ...
        let factsAfter = db.collection("users").document(user).collection("Crisis").document(date).collection("facts").document("Emotion After")
        ...
        let factsUse = db.collection("users").document(user).collection("Crisis").document(date).collection("facts").document("Usefulness")
        ...
        //tipp
        let tippEmo = db.collection("users").document(user).collection("Crisis").document(date).collection("tipp").document("Emotion")
        ...
        let tippAfter = db.collection("users").document(user).collection("Crisis").document(date).collection("tipp").document("Emotion After")
        ...
        let tippUse = db.collection("users").document(user).collection("Crisis").document(date).collection("tipp").document("Usefulness")
        ...
        //breathe
        let breatheEmo = db.collection("users").document(user).collection("Crisis").document(date).collection("breathe").document("Emotion")
        ...
        let breatheAfter = db.collection("users").document(user).collection("Crisis").document(date).collection("breathe").document("Emotion After")
        ...
        let breatheUse = db.collection("users").document(user).collection("Crisis").document(date).collection("breathe").document("Usefulness")
        ...
        //soothe
        let sootheEmo = db.collection("users").document(user).collection("Crisis").document(date).collection("soothe").document("Emotion")
        ...
        let sootheAfter = db.collection("users").document(user).collection("Crisis").document(date).collection("soothe").document("Emotion After")
        ...
        let sootheUse = db.collection("users").document(user).collection("Crisis").document(date).collection("soothe").document("Usefulness")
        ...
        //improve
        let improveEmo = db.collection("users").document(user).collection("Crisis").document(date).collection("improve").document("Emotion")
        ...
        let improveAfter = db.collection("users").document(user).collection("Crisis").document(date).collection("improve").document("Emotion After")
        ...
        let improveUse = db.collection("users").document(user).collection("Crisis").document(date).collection("improve").document("Usefulness")
        ...
        //accepts
        let acceptsEmo = db.collection("users").document(user).collection("Crisis").document(date).collection("accepts").document("Emotion")
        ...
        let acceptsAfter = db.collection("users").document(user).collection("Crisis").document(date).collection("accepts").document("Emotion After")
        ...
        let acceptsUse = db.collection("users").document(user).collection("Crisis").document(date).collection("accepts").document("Usefulness")
        ...
        //opposite
        let oppositeEmo = db.collection("users").document(user).collection("Crisis").document(date).collection("opposite").document("Emotion")
        ...
        let oppositeAfter = db.collection("users").document(user).collection("Crisis").document(date).collection("opposite").document("Emotion After")
        ...
        let oppositeUse = db.collection("users").document(user).collection("Crisis").document(date).collection("opposite").document("Usefulness")
